...
class Eg002SigningViaEmailController:
    ...
    def make_envelope(cls, args, doc_docx_path, doc_pdf_path):
        ...
        # Initialize recipients list with signer
        recipients_list = [signer1]

        # Add CC recipient only if email is provided
        if args.get("cc_email") and args.get("cc_name"):
            cc1 = CarbonCopy(
                email=args["cc_email"],
                name=args["cc_name"],
                recipient_id="2",
